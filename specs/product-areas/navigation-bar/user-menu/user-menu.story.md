...
4. The dropdown contains the following items in order:
   - **Change Password** — navigates to the dedicated change-password page.
   - A visual separator.
...
- Dropdown panel with change-password action and log out.
...
- Explicit "Profile" navigation link in the dropdown (the profile-quick-glance header already serves as the profile page shortcut).
...
- The profile-quick-glance header at the top of the dropdown acts as the sole navigation shortcut to the profile page.
...
- Profile-quick-glance header is implemented (provides navigation to the profile page).
- Dedicated change-password page is routed.
...
3. User clicks the trigger — dropdown opens with Change Password, separator, Log out.
4. User clicks "Change Password" — navigated to the dedicated change-password page, dropdown closes.
